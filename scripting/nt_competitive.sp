...
#define TESTS_INCLUDED_MATCHMAKE 1
#if defined TESTS_INCLUDED_MATCHMAKE && TESTS_INCLUDED_MATCHMAKE != 1
	#error TESTS_INCLUDED_MATCHMAKE needs to be undefined or equal 1.
#endif
